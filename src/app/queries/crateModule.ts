...
export default gql`
    mutation AddModule($name: String!, $bodytext: String!, $price: Float!, $groupId: ID, $categoryId: ID, $defaultModule: Boolean, $internalHours: Float, $externalHours: Float, $pricePerHour: Int) {
